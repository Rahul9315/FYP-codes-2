...
capture = pyshark.LiveCapture(interface=INTERFACE, bpf_filter="icmp or udp or tcp")
...
for packet in capture.sniff_continuously(packet_count=20):  # Capture 20 packets
    try:
        ...
        packet_data.append([eth_type, packet_length, service, src_ip, dst_ip, src_port, dst_port, protocol_name, tcp_flags, checksum, tcp_window_size , icmp_type ])
