# source my_venv_env/bin/activate  # to open the python environment
...
for packet in capture.sniff_continuously(packet_count=20):  # Capture 20 packets
    try:
        ...
        # Append data to the list
        packet_data.append([eth_type, packet_length, service, src_ip, dst_ip, src_port, dst_port, protocol_name, tcp_flags, checksum, tcp_window_size , icmp_type , detections])
